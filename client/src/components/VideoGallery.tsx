...
const videos = [
  ...
  {
    id: "0H4JUd-fdoQ",
    title: "Hull Clean - Catamaran After",
    date: "2025",
  },
  {
    id: "gtsiId2rd-A",
    title: "Hull Clean - Catamaran Before",
    date: "2025",
  },
  {
    id: "_IxxoYyr9EA",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We document every job with professional underwater video footage.
            See our work quality for yourself.
          </p>
        </div>
